...
**Граф далёк от простоты и представлен здесь только для того, чтобы автор библиотеки помнил как работает его собственный код. Поэтому предлагаю не заострять внимание. Пользоваться gia_tga можно и без знания графа.**
