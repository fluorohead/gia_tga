...
```
Текущее состояние хранится внутри класса и 'снаружи' его состояния не видно, но есть возможность (**которой нужно обязательно пользоваться - it's mandatory!**) анализировать возвращаемые ошибки. Практически все методы класса умеют их возвращать.
...
В следующем графе отражены все методы класса **GIA_TgaDecoder** и последовательность их вызовов :
