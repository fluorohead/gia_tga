...
- результатом работы всегда является указатель на байтовый буфер раскодированных данных с порядком организации **QImage::Format_RGBA8888**, на основе которого можно создать объект класса **QImage** или **QPixmap**
