...
**Граф далёк от простоты и представлен здесь только, чтобы автор библиотеки помнил как работает его собственный код. Поэтому предлагаю не заострять на это внимание. Пользоваться gia_tga можно и без знания этих тонкостей.**
