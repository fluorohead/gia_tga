...
Библиотека существует в двух варинтах : для использования в среде фреймворка **Qt**, а так же более универсальный под **STL**.
...
- методы сделаны в виде своебразных "шагов", что повышает гибкость использования (вам не нужно раскодировать, а нужно только считать данные? - пожалуйста! вы просто не вызываете раскодировщик)
...
**Граф далёк от простоты и представлен здесь, чтобы автор библиотеки помнил как работает его собственный код. Поэтому предлагаю не заострять на это внимания. Пользоваться gia_tga можно и без этих тонкостей.**
...
Вы можете использовать библиотеку в некоммерческих проектах, но с условием обязательного указания ссылки на эту страницу.
