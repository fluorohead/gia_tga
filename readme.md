...
|**detach_data**|Отвязывает указатель на декодированные данные от класса. С этого момента класс 'забывает' про указатель и больше не несёт ответственности за высвобождение памяти, занимаемой декодированным массивом. Возвращает **Success** в случае удачи. Либо возвращает **NeedDecoding**, требуя предварительного декодирования ресурса.|*Success*, *NeedDecoding*|
